#-*- coding:utf-8 -*-
"""
Create version control menu and add file associations.
"""
__author__ = 'jeremyjone'
__datetime__ = '2018-09-21 15:01'
...
desktop_name = "ffm-version-control.desktop"
menu_name = "FFM Version Control"
...
'''.format(menu_name, menu_name, menu_name,
           config.VERSION_CONTROL_START_FILE,
...
def createLogfile():
    ...
    log_name = config.LOG_VERSION_CTRL_FILE_NAME
